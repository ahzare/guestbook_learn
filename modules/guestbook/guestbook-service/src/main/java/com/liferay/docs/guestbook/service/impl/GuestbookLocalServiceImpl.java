...
public class GuestbookLocalServiceImpl extends GuestbookLocalServiceBaseImpl {
    ...
    public Guestbook deleteGuestbook(long guestbookId,
        ...
        System.out.println("alls = " + assetLinkLocalService + " ae = " + assetEntry);
        // if not null condition for preventing null pointer exception
        if (assetLinkLocalService != null && assetEntry != null) {
            assetLinkLocalService.deleteLinks(assetEntry.getEntryId());
        }

        System.out.println("aels = " + assetEntryLocalService + " ae = " + assetEntry);
        // if not null condition for preventing null pointer exception
        if (assetEntryLocalService != null && assetEntry != null) {
